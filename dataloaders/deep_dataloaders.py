...
def get_dataloaders_deep_learning(data_root, use_tda, batch_size, fold_index):    
    ...
    train_dataset = CustomDataset(masih_root, masih_train_dict, train=True, use_tda=use_tda)
    val_dataset = CustomDataset(masih_root, masih_val_dict, train=False, use_tda=use_tda)
    test_dataset = CustomDataset(masih_root, masih_test_dict, train=False, use_tda=use_tda)
    ...
    val_loader = DataLoader(val_dataset, batch_size=256, shuffle=False, num_workers=2, collate_fn=collate_fn)
